...
plot(N, D1mc2b, xlim=range(c(0,200^2)),ylim=range(c(100,30000)),type="p",pch=19, col="blue",lwd=1.5,xlab="", ylab="",
     main="",cex=1.8,tck=0.02, cex.axis=2.0)
...
par(new = TRUE) #tells R to make the second plot without cleaning the first
plot(N, D1mc2rb,
     ylim=range(c(100,30000)),type="p",pch=19, col="magenta",lwd=1.5,xlab="", ylab="",
     main="",cex=1.8,tck=0.02, cex.axis=2.0,xaxt='n',yaxt='n')
par(new = TRUE) #tells R to make the second plot without cleaning the first
curve(0.0665*x^{1.1964},0^2,200^2, xlim=range(c(0,200^2)), ylim=c(0,30000),xlab="", ylab="",xaxt='n',yaxt='n',lty="dotdash",lwd=3.0)
par(new = TRUE)
plot(N, D1mc2r,
     ylim=range(c(100,30000)),type="p",pch=19, col="red",lwd=1.5,xlab="", ylab="",
     main="",cex=1.8,tck=0.02, cex.axis=2.0,xaxt='n',yaxt='n')
par(new = TRUE) #tells R to make the second plot without cleaning the first
...
D1mc2brn<-c(425,775,'',1820,'',4224,'')
D1mc2rn<-c(348,763,1374,1804,3058,4188,5485)

#par(lwd=2.5,cex=1.5,mfrow=c(1,2))
plot(M, D1mc2rn,
     ylim=range(c(100,6000)),type="p",pch=19, col="red",lwd=1.5,xlab="", ylab="",
     main="",cex=1.8,tck=0.02, cex.axis=2.0)
par(new = TRUE) #tells R to make the second plot without cleaning the first
curve(0.3462*x^{0.9103},0^2,200^2, xlim=range(c(0,200^2)), ylim=c(0,6000),xlab="", ylab="",xaxt='n',yaxt='n',lty="dotdash",lwd=3.0)
par(new = TRUE) #tells R to make the second plot without cleaning the first
plot(M, D1mc2brn,
     ylim=range(c(100,6000)),type="p",pch=19, col="magenta",lwd=1.5,xlab="", ylab="",
     main="",cex=1.8,tck=0.02, cex.axis=2.0,xaxt='n',yaxt='n')
par(new = TRUE) #tells R to make the second plot without cleaning the first
...
plot(M, D1mc2bn,
       ylim=range(c(100,6000)),type="p",pch=19, col="blue",lwd=1.5,xlab="", ylab="",
       main="",cex=1.8,tck=0.02, cex.axis=2.0,xaxt='n',yaxt='n')
par(new = TRUE) #tells R to make the second plot without cleaning the first
